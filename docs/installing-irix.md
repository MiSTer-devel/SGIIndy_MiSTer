...
Everything below was done on a DE10-Nano with build 44 — the logic of the
release in `releases/` (SGIIndy_20260918), from an earlier fit — and the
IRIX 5.3 CD image described next, on 2026-09-18.
